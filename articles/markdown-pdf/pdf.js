...
var pdf = exports.pdf = function(){
  ...
  var putResources = function() {
    var font;
    if(documentProperties.fonts) {
      for( font in documentProperties.fonts ) {
        putFonts(font);
      }
    } else {
        putFonts('Helvetica');      
  ...
  var putFonts = function(font) {
    ...
    newObject();
    var fontNumber = fontsNumber[font] = objectNumber;
  ...
  var putResourceDictionary = function() {
    ...
    var i = 0, fx;
    for( var index in fontsNumber ) {
      fx = documentProperties.fonts ? documentProperties.fonts[index] : 'F' + (++i);
      out('/' + fx + ' ' + fontsNumber[index] + ' 0 R');
    }
  ...
  var _addPage = function() {
    ...
    out('BT /F1 ' + parseInt(fontSize, 10) + '.00 Tf ET');    
  };
  ...
  return {
    ...
    text: function(x, y, text, font) {
      
      font = font || 'Helvetica';
      
      // need page height
      if(pageFontSize != fontSize) {
        out('BT /' + documentProperties.fonts[font] + ' ' + parseInt(fontSize, 10) + '.00 Tf ET');
        pageFontSize = fontSize;
      }
